...
public class LabRequestController {
    ...
    //Get List of all the TestRequests that are in "INITIATED" Status.
    ...
    //Get List of all the TestRequests that are assigned to the current logged in User (Tester).
    @GetMapping
    @PreAuthorize("hasAnyRole('TESTER')")
    ...
    //Assign the specific TestRequest to the current logged in User (Tester).
    @PreAuthorize("hasAnyRole('TESTER')")
    ...
    //Update the specific TestRequest with the Lab Results by the tester.
    @PreAuthorize("hasAnyRole('TESTER')")
