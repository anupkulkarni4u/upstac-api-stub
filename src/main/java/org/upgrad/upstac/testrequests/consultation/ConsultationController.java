...
public class ConsultationController {
    ...
    //Get List of all the TestRequests that are in "LAB_TEST_COMPLETED" Status.
    @GetMapping("/in-queue")
    ...
    //Get List of all the TestRequests that are assigned to the current logged in User (Doctor).
    @GetMapping
    @PreAuthorize("hasAnyRole('DOCTOR')")
    ...
    //Assign the specific TestRequest to the current logged in User (Doctor).
    @PreAuthorize("hasAnyRole('DOCTOR')")
    ...
    //Update the specific TestRequest with the consultation details of the doctor.
    @PreAuthorize("hasAnyRole('DOCTOR')")
